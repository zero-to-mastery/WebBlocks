/* 
    Icons properties are used to develop the component. Using svg as an image removes the flexibility of customization
    With the required properties we can construct a SVG and insert it into the shadow dom component.
    We can add hover effects and necessary customizations
*/
