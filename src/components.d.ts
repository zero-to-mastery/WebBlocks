...
declare global {
  ...
  interface HTMLSimpleCalculatorElement extends Components.SimpleCalculator, HTMLStencilElement {}
  var HTMLSimpleCalculatorElement: {
    prototype: HTMLSimpleCalculatorElement;
    new (): HTMLSimpleCalculatorElement;
  };
  ...
  interface HTMLElementTagNameMap {
    ...
    'simple-calculator': HTMLSimpleCalculatorElement;
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'simple-calculator': LocalJSX.SimpleCalculator & JSXBase.HTMLAttributes<HTMLSimpleCalculatorElement>;
